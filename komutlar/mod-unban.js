...
module.exports.run = async (client, message, args) => {
  ...
  const userError = new Discord.MessageEmbed()
    .setColor('#ed455a')
      .setTitle('• Hata: 02 •')
        .setDescription('**Yasağı kaldırmak için bir kullanıcı kimliği girmelisiniz rr!unban İD`**')
...
message.channel.send(`<@!${user}> Adlı Kullanıcının Yasağı Başarıyla Kaldırıldı <a:onayytikk:811491281883627532>`)
