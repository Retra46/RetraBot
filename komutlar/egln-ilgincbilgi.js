...
exports.run = (client, message, args) => {
    var ilgincsöz = [
        ...
        "Hapşırdığınızda beyin hücrelerinizin bir kısmının öldüğünü biliyor muydunuz? Ya da hayatınızın yaklaşık 6'da 1'inin çarşamba günlerinde geçtiğini duymuş muydunuz? Birazdan okuyacağınız ilginç bilgiler size tüm bildiklerinizi unutturacak.",
        "Araştırmalara Göre Kadın Cinsel Organizmalarına Dokunmak Erkeklerde Stresi %70 Oranında Azaltıyor!",
        ...
        "Kırbacın çatlama sesi çıkarmasının sebebi, ucunun sesten daha hızlı hareket etmesidir.",
